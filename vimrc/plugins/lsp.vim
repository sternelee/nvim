...
"     buf_set_keymap("n", "fm", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
"   end
...
" -- npm install --global vscode-html-languageserver-bin vls typescript typescript-language-server vscode-css-languageserver-bin bash-language-server vscode-json-languageserver stylelint-lsp
